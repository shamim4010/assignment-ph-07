...
function Card({friend}) {
    ...
    const clickHandler = (name, m) => {
        ...
        m === 'Call' ? toast(`Successfully call ${name}`, {autoClose: 2000}) : m === 'Message' ? toast(`Successfully Message ${name}`, {autoClose: 2000}) : toast(`Successfully VideoCall ${name}`, {autoClose: 2000});
    }
